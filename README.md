...
| **Thalamus** | The semantic control layer for AI traffic (canonical: `thalamus-core`, ADR-0001). Implements the agent-facing protocol in `spec/protocol.md`; decides and validates AI-mediated calls, transport is the data plane below it |
